...
wire                   clk_en;
wire                   is_odd;
reg   [RATIO_WD-1 : 0] i_div_ratio_reg;
...
assign is_odd = i_div_ratio_reg[0] ;
assign edge_flip_half = ((i_div_ratio_reg >> 1) - 1 ) ;
assign edge_flip_full = (i_div_ratio_reg >> 1) ;

assign is_zero = ~|i_div_ratio_reg ;                               // check if ratio equals to 0 
assign is_one  = (i_div_ratio_reg == 1'b1) ;                       // check if ratio equals to 1 
