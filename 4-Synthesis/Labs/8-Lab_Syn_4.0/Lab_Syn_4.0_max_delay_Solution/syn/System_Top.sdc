...
# Created by write_sdc on Thu Aug 20 22:51:33 2026
...
set_max_delay 5  -from [list [get_cells U0_SER_2_PAR/PAR_DATA_VLD_reg] [get_cells {U0_SER_2_PAR/PAR_DATA_reg[7]}] [get_cells {U0_SER_2_PAR/PAR_DATA_reg[6]}] [get_cells {U0_SER_2_PAR/PAR_DATA_reg[5]}] [get_cells {U0_SER_2_PAR/PAR_DATA_reg[4]}] [get_cells {U0_SER_2_PAR/PAR_DATA_reg[3]}] [get_cells {U0_SER_2_PAR/PAR_DATA_reg[2]}] [get_cells {U0_SER_2_PAR/PAR_DATA_reg[1]}] [get_cells {U0_SER_2_PAR/PAR_DATA_reg[0]}]]  -to [list [get_cells {U0_DATA_SYNC/sync_bus_reg[7]}] [get_cells {U0_DATA_SYNC/sync_bus_reg[6]}] [get_cells {U0_DATA_SYNC/sync_bus_reg[5]}] [get_cells {U0_DATA_SYNC/sync_bus_reg[4]}] [get_cells {U0_DATA_SYNC/sync_bus_reg[3]}] [get_cells {U0_DATA_SYNC/sync_bus_reg[2]}] [get_cells {U0_DATA_SYNC/sync_bus_reg[1]}] [get_cells {U0_DATA_SYNC/sync_bus_reg[0]}]]
