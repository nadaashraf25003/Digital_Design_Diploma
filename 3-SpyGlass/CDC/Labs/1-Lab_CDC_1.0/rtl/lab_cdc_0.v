...
always @(posedge CLKA or negedge RSTA_N) begin
    if (!RSTA_N) begin
        ...
        if (DATA_VALID_A) begin           // replace DATA_VALID_A by DATA_VALID_A_PULSE 
...
/*
// Method 1 : Enable Based Synchronization Method
always @(posedge CLKB or negedge RSTB_N) begin
    if (!RSTB_N) begin
        DATA_OUT_B <= 8'h00;
    end
...
/*
// Method 2 : Recirculation MUX Based Synchronization Method
